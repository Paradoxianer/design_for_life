...
class StaticTimelineData {
  static final List<DflSession> sessions = [
    ...
    DflSession(
      id: 'session_8a',
      title: 'Imagine – Rückblick & Ausblick',
      description: 'Wähle je ein abstraktes Bild für deine Vergangenheit und deine Zukunft.',
      type: SessionType.personalReflection,
      moduleRoute: 'imagine/session_8a?title=Imagine',
    ),
    DflSession(
      id: 'session_8b',
      title: 'Synthesis – Gruppenarbeit',
      description: 'Synthese aus Gaben, Werten, hörendem Gebet und Zielen.',
      type: SessionType.groupWork,
      moduleRoute: 'synthesis?title=Synthesis',
    ),
    DflSession(
      id: 'session_9',
